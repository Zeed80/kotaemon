...
APPLICATION_TO_ENV: dict[str, str] = {
    ...
    "vectorstore_type": "KH_VECTORSTORE_TYPE",
    "pg_vector_embed_dim": "PG_VECTOR_EMBED_DIM",
    "pg_vector_hnsw_m": "PG_VECTOR_HNSW_M",
    "pg_vector_hnsw_ef_construction": "PG_VECTOR_HNSW_EF_CONSTRUCTION",
    "pg_vector_hnsw_ef_search": "PG_VECTOR_HNSW_EF_SEARCH",
    ...
    "enable_vlm_document_classification": "ENABLE_VLM_DOCUMENT_CLASSIFICATION",
